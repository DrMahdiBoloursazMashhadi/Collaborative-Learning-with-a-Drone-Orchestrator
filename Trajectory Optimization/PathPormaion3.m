...
size_square = 70;
iteration_max=1;
problem = 0;H=20;d=10;ld = size_square/d;GapNormalized = [];PhiNormalized = [];fix_itrs = [1;2;3];n = 3;D = 10000;
...
%             Error_Path_total(wt_itr)=CalcErrorPathFunc(x,points_op,Objective_function);
            ...
            save(['C:\Users\mm03263\OneDrive - University of Surrey\Desktop\data\results\path-planning\7000\' num2str(k) '/U_'  num2str(wt)  '.mat'],'points_op','puav_op_comm','wc','errors_op','errors_op_comm','errors_wc','D_k');
