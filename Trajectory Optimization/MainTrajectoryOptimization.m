...
%%%%%%%%%%%%%%%%%%% User Placement and Speed Assignment %%%%%%%%%%%%%%%%%%%
start_point = wc;
...
save(['C:\Users\mb0110\OneDrive - University of Surrey\Desktop\data\results\path-planning\moving\150\different_noise_levels\errors.mat'],'errors_op','errors_op_comm','errors_wc','All_coordinates','points_op_a','points_wc_a','points_op_comm_a','V');