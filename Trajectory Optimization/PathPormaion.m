...
v_max=25;run_max=1;WT=[1];T_max = 150;
eta = 0.1;M=28*28;
c2 = 0.5;
c1 = 1;
...
%             Error_Path_total(wt_itr)=CalcErrorPathFunc(x,points_op,Objective_function);
            ...
            save(['C:\Users\mm03263\OneDrive - University of Surrey\Desktop\data\results\path-planning\150\' num2str(k) '/U_'  num2str(wt)  '.mat'],'points_op','puav_op_comm','wc','errors_op','errors_op_comm','errors_wc','D_k');
