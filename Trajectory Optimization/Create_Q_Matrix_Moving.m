function all_Q= Create_Q_Matrix_Moving(x,k,all_coordinates,theta,B,N0,p_k,D_k,pi,fc,cc,L,D,eta1,H, alpha, T,wt, mu,c2)
   
   thershold = T/wt;
   itr2=2; all_Q=sym(ones(T-1,T-1));
  
   while itr2<=T
        coordinates = cell2mat(all_coordinates(itr2));
